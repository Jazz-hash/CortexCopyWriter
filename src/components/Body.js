      ...
      <div id="anchor-services" className="services service-outer-1">
          ...
          <div className="row-inner service-section-1" id="services">
            <div className="column column-left">
              <div className="service-image">
                <img src="img/services/services-6.svg" />
              </div>
            </div>
        ...
        <div className="row row-service ">
          <div className="row-inner service-section-2">
            ...
            <div className="column column-right">
              <div className="service-image">
                <img src="img/services/services-7.svg" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="row row-service ">
          <div className="row-inner service-section-3">
            <div className="column column-left">
              <div className="service-image">
                <img src="img/services/services-5.svg" />
              </div>
            </div>
            <div className="column column-right">
              ...
              <div className="taglist">
                ...
                <div className="tag">Blogs &amp; Articles</div>
                <div className="tag">Social Media Content</div>
                <div className="tag">Video Scripts</div>
                <div className="tag">eDMs &amp; Newsletters</div>
                <div className="tag">Case Studies</div>
                <div className="tag">Whitepapers</div>
              </div>
            </div>
          </div>
        </div>
